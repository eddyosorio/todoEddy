...
using todoEddy.Common.Models;
using todoEddy.Common.Responses;
using todoEddy.Functions.Entities;

namespace todoEddy.Functions.Functions
{
    public static class TodoApi
    {
        ...
        public static async Task<IActionResult> CreateTodo(
            ...
            ILogger log)
        {
            log.LogInformation("Receivedd a new todo");
        ...
        public static async Task<IActionResult> UpdateTodo(
           ...
           ILogger log)
        {
            log.LogInformation($"Update a new todo: {id}, received");
        ...
        public static async Task<IActionResult> GetAllTodos(
            ...
            ILogger log)
        {
            log.LogInformation("Get all todos Receivedd ");
